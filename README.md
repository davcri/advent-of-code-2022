I'm doing Advent of Code 2022 with Rust lang in order to explore the language and hopefully start using it to create CLI tools and WASM modules to be run on the web.
